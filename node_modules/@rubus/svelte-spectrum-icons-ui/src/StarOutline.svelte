<script>
  ...
  export let width = "";
  export let height = "";
  export let ariaLabel = "StarOutline";
  let path;
  let sw;
  let sh;
...
<svg
  ...
  {#if scale === 'L'}
    <path
      bind:this={path}
    d="M11 4.9l1.231 3.255A1.777 1.777 0 0013.809 9.3l3.476.165-2.715 2.18a1.777 1.777 0 00-.6 1.855l.918
...
/>
  {:else if scale === 'M'}
    <path
      bind:this={path}
    d="M9.031 2.541l1.777 4.753 5.11.241-3.987 3.2 1.336 4.913-4.266-2.782-4.282 2.808 1.352-4.937-3.987-3.2
