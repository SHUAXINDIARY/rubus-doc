<script>
  ...
  export let width = "";
  export let height = "";
  export let ariaLabel = "HelpMedium";
  let path;
  let sw;
  let sh;
...
<svg
  ...
  {#if scale === 'L'}
    <path
      bind:this={path}
    d="M11 2a9 9 0 109 9 9 9 0 00-9-9zm-.007 14.681a1.145 1.145 0 01-1.227-1.215 1.159 1.159 0
...
/>
  {:else if scale === 'M'}
    <path
      bind:this={path}
    d="M9 1a8 8 0 108 8 8 8 0 00-8-8zm1.3 12.3a1.222 1.222 0 01-.3.9 1.223 1.223 0 01-.9.3 1.2 1.2 0 010-2.4c.8 0 1.3.5
