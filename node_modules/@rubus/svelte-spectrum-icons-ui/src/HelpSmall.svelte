<script>
  ...
  export let width = "";
  export let height = "";
  export let ariaLabel = "HelpSmall";
  let path;
  let sw;
  let sh;
...
<svg
  ...
  {#if scale === 'L'}
    <path
      bind:this={path}
      d="M9 1a8 8 0 108 8 8 8 0 00-8-8zm.023 13.438a1.345 1.345 0 01-.104-2.688q.052-.002.104 0a1.31 1.31 0 011.397
  ...
  {:else if scale === 'M'}
    <path
      bind:this={path}
      d="M7 .778A6.222 6.222 0 1013.222 7 6.222 6.222 0 007 .778zm.018 10.452a1.046 1.046 0 11-.08-2.091q.04-.002.08
