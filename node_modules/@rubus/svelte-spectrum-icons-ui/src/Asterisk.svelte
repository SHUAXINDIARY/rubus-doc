...
<svg
  ...
  {#if scale === 'L'}
    <path
      bind:this={path}
      d="M7.867 7.872c.061.062.103.145 0 .228l-1.283.827c-.104.061-.145.02-.186-.083L4.804 6.07l-2.09
  ...
  {:else if scale === 'M'}
    <path
      bind:this={path}
      d="M6.573 6.558c.056.055.092.13 0 .204l-1.148.74c-.093.056-.13.02-.167-.073L3.832 4.947l-1.87
