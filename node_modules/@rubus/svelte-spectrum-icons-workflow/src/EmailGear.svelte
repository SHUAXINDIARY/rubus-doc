<script>
  ...
  export let ariaLabel = "EmailGear";
  let autoScale = 18;
  afterUpdate(() => {
...
<svg
  ...
  <path
    d="M11.165 15.938L0 7.511v16.684l11.165-8.257zM34.925 24.678H32.61a6.69 6.69 0 0 0-.977-2.373l1.648-1.648a.661.661 0
    ...
    1-3.6 3.6z" />
  <path
    d="M16.953 29.72a3.065 3.065 0 0 1-2.94-3.059v-1.322a3.065 3.065 0 0 1 2.938-3.059 3.044 3.044 0 0 1-.826-2.091
  ...
  <path
    d="M34.925 24.678H32.61a6.69 6.69 0 0 0-.977-2.373l1.648-1.648a.661.661 0 0 0 0-.935l-1-1a.661.661 0 0 0-.935 0L29.7
