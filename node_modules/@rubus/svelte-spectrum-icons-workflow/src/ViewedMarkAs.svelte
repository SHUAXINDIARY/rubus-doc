<script>
  ...
  export let ariaLabel = "ViewedMarkAs";
  let autoScale = 18;
  afterUpdate(() => {
...
<svg
  ...
  <path
    d="M22.794 15.554A5 5 0 0 0 23.063 14a4.691 4.691 0 0 0-.175-1.2 2.623 2.623 0 0 1-2.221 1.279A2.667 2.667 0 0 1 18
    11.417a2.631 2.631 0 0 1 1.35-2.269 4.916 4.916 0 0 0-1.35-.21 5.052 5.052 0 0 0-.272 10.1 12.3 12.3 0 0 1
    5.066-3.484z" />
  <path
    d="M15.477 22.831A9.207 9.207 0 1 1 27.225 14c0 .276-.057.537-.081.807a12.227 12.227 0 0 1 5.894 1.583 4.365 4.365 0
  ...
  <path
    d="M27 18.1a8.9 8.9 0 1 0 8.9 8.9 8.9 8.9 0 0 0-8.9-8.9zm-2.338 14.312l-4.128-4.128a.5.5 0 0 1
