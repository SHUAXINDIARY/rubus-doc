<script>
  ...
  export let ariaLabel = "UploadToCloudOutline";
  let autoScale = 18;
  afterUpdate(() => {
...
<svg
  ...
  <path
    d="M13.5 18H16v15a1 1 0 0 0 1 1h2a1 1 0 0 0 1-1V18h2.5a.5.5 0 0 0 .5-.5.489.489 0 0 0-.117-.317l-4.519-5.023a.5.5 0
