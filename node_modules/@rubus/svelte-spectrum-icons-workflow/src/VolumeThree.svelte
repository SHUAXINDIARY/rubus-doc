<script>
  ...
  export let ariaLabel = "VolumeThree";
  let autoScale = 18;
  afterUpdate(() => {
...
<svg
  ...
  <path
    d="M6.745 12.073H1a1 1 0 0 0-1 1V23a1 1 0 0 0 1 1h5.745a1.428 1.428 0 0 1 .931.345l7.13 7.259A.727.727 0 0 0 16
  ...
  <path
    d="M28.04 18a12.938 12.938 0 0 1-3.115 8.435.973.973 0 0 0 .063 1.317l.014.014a1 1 0 0 0 1.474-.069 14.98 14.98 0 0
    0-.026-19.429 1 1 0 0 0-1.469-.068l-.014.015a.977.977 0 0 0-.067 1.319A12.937 12.937 0 0 1 28.04 18z" />
  <path
    d="M34.04 18a18.92 18.92 0 0 1-4.823 12.642 1 1 0 0 0 .024 1.375l.014.015a.982.982 0 0 0 1.422-.023A20.865 20.865 0
