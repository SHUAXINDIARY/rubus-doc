<script>
  ...
  export let ariaLabel = "CalendarLocked";
  let autoScale = 18;
  afterUpdate(() => {
...
<svg
  ...
  <path
    d="M35.161 24.048h-1.244v-1.477C33.917 17.837 30.372 14 26 14s-7.917 3.837-7.917 8.571v1.477h-1.291a.826.826 0 0
  ...
  <path
    d="M13.467 25a2.963 2.963 0 0 1 .179-1H4V6h4v1a1 1 0 0 0 1 1h2a1 1 0 0 0 1-1V6h10v1a1 1 0 0 0 1 1h2a1 1 0 0 0
