<script>
  ...
  export let ariaLabel = "FacebookCoverImage";
  let autoScale = 18;
  afterUpdate(() => {
...
<svg
  ...
  <path
    d="M13.136 28.345v-1.014a.7.7 0 0 1 .177-.452 5.386 5.386 0 0 0 1.2-3.34c0-2.527-1.326-3.94-3.33-3.94s-3.368
  ...
  <path
    d="M33 4H3a1 1 0 0 0-1 1v23.4a1.551 1.551 0 0 0 .291.9 7.336 7.336 0 0 1 3.221-2.564 8.159 8.159 0 0 1-.693-3.2
