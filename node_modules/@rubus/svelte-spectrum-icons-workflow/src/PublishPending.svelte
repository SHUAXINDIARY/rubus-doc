<script>
  ...
  export let ariaLabel = "PublishPending";
  let autoScale = 18;
  afterUpdate(() => {
...
<svg
  ...
  <path
    d="M33.191 1.113L1.8 10.478a.5.5 0 0 0-.08.926l7.92 3.954zM15.645 22.372L10.08 19.25v7.639a.713.713 0 0 0
  ...
  <path
    d="M30.849 32.687A6.772 6.772 0 0 1 27 33.9a6.876 6.876 0 0 1-1.2-13.651v-2.007A8.867 8.867 0 0 0 27 35.9a8.733
