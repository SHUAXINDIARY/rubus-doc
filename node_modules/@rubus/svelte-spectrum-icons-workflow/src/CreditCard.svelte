<script>
  ...
  export let ariaLabel = "CreditCard";
  let autoScale = 18;
  afterUpdate(() => {
...
<svg
  ...
  <path
    d="M2 32.512A1.488 1.488 0 0 0 3.488 34h26.778a1.488 1.488 0 0 0 1.488-1.488V30H2zM30.065 19.026c-2.341 1.174-10.486
  ...
  <path
    d="M11.5 13.172s.265-1.214.791-3.135c.358-1.31 4.972-7.053 6.739-7.642 1.743-.582 11.51-1.125 11.51-1.125L35
