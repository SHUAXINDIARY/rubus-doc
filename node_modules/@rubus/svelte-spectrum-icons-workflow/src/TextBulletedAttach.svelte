<script>
  ...
  export let ariaLabel = "TextBulletedAttach";
  let autoScale = 18;
  afterUpdate(() => {
...
<svg
  ...
  <path
    d="M12 17v2a1 1 0 0 0 1 1h6.7l3.8-3.8c.074-.074.163-.127.24-.2H13a1 1 0 0 0-1 1zM33 4H13a1 1 0 0 0-1 1v2a1 1 0 0 0 1
