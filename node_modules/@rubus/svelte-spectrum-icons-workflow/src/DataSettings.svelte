<script>
  ...
  export let ariaLabel = "DataSettings";
  let autoScale = 18;
  afterUpdate(() => {
...
<svg
  ...
  <path
    d="M15 27a11.972 11.972 0 0 1 .347-2.82C10.288 23.856 3.5 22.653 2 20.27V29c0 2.683 6.769 4.866 15.258 4.988A11.932
  ...
  <path
    d="M35.193 25.786h-2.125a6.125 6.125 0 0 0-.9-2.179l1.513-1.513a.607.607 0 0 0 0-.858l-.92-.92a.607.607 0 0 0-.858
