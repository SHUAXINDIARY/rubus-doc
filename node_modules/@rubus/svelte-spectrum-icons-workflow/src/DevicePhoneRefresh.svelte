<script>
  ...
  export let ariaLabel = "DevicePhoneRefresh";
  let autoScale = 18;
  afterUpdate(() => {
...
<svg
  ...
  <path
    d="M16 30H8V6h16v9.347a11.6 11.6 0 0 1 2-.416V2a2 2 0 0 0-2-2H8a2 2 0 0 0-2 2v32a2 2 0 0 0 2 2h8zM15 2h2a1.04 1.04 0
    0 1 1 1 1.041 1.041 0 0 1-1 1h-2a1.024 1.024 0 0 1-1-1 1.024 1.024 0 0 1 1-1z" />
  <path
    d="M18.4 24.451a8.882 8.882 0 0 1 15.5-3.09l1.251-1.251a.486.486 0 0 1 .349-.147.5.5 0 0 1 .5.5v5.051a.472.472 0 0
