<script>
  ...
  export let ariaLabel = "CollectionLink";
  let autoScale = 18;
  afterUpdate(() => {
...
<svg
  ...
  <path
    d="M15.136 28H14V18h8v1.208l1.937-1.937L25.207 16H24V6h8v7.063a7.552 7.552 0 0 1 2 .428V5a1 1 0 0 0-1-1H3a1 1 0 0
    0-1 1v24a1 1 0 0 0 1 1h12.065a7.664 7.664 0 0 1 .071-2zM14 6h8v10h-8zm-2 22H4V18h8zm0-12H4V6h8z" />
  <path
    d="M25.548 25.421a2.165 2.165 0 0 0 .421.611 2.19 2.19 0 0 0 3.094 0l3.609-3.609a2.188 2.188 0 0
