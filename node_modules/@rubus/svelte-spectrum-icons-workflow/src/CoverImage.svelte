<script>
  ...
  export let ariaLabel = "CoverImage";
  let autoScale = 18;
  afterUpdate(() => {
...
<svg
  ...
  <path
    d="M34.875 4H1.125A1.068 1.068 0 0 0 0 5v22a1.068 1.068 0 0 0 1.125 1h2.4a13.248 13.248 0 0 1 3.24-1.088 11.565
  ...
  <path
    d="M24 34.038a3.12 3.12 0 0 0-1.048-2.353 10.109 10.109 0 0 0-5.738-2.234 1.144 1.144 0 0 1-.99-1.148v-1.658a1.114
