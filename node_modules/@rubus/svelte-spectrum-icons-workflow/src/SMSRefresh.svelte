<script>
  ...
  export let ariaLabel = "SMSRefresh";
  let autoScale = 18;
  afterUpdate(() => {
...
<svg
  ...
  <path
    d="M33 4.1H3a1 1 0 0 0-1 1v22a1 1 0 0 0 1 1h5l3.536 6.839a.5.5 0 0 0 .928 0l2.581-4.992a12.131 12.131 0 0 1
  ...
  <path
    d="M27.1 33.463a6.143 6.143 0 0 1-4.718-2.1l2.282-2.287H18.2v6.477l2.476-2.481A8.648 8.648 0 0 0 27.1 36a9.2 9.2 0 0
