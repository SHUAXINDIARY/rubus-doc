<script>
  ...
  export let ariaLabel = "AssetCheck";
  let autoScale = 18;
  afterUpdate(() => {
...
<svg
  ...
  <path
    d="M10 10.2a3.447 3.447 0 0 0-2.1-1.375c-1.845 0-5.9 5.588-5.9 5.588V2h22v6h2V1a1 1 0 0 0-1-1H1a1 1 0 0 0-1 1v18a1 1
    0 0 0 1 1h9z" />
  <path
    d="M15.059 30H14.5a.5.5 0 0 1-.5-.5v-3a.5.5 0 0 1 .5-.5h.256a12.2 12.2 0 0 1 .659-3H14.5a.5.5 0 0 1-.5-.5v-3a.5.5 0
  ...
  <path
    d="M27 18.1a8.9 8.9 0 1 0 8.9 8.9 8.9 8.9 0 0 0-8.9-8.9zm-2.338 14.312l-4.128-4.127a.5.5 0 0 1
