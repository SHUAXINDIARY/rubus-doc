<script>
  ...
  export let ariaLabel = "EmailKeyOutline";
  let autoScale = 18;
  afterUpdate(() => {
...
<svg
  ...
  <path
    d="M25.947 30H2v-2.392l11.165-8.358 3.635 2.725a2 2 0 0 0 2.4 0l3.088-2.325a7.977 7.977 0 0
  ...
  <path
    d="M35.445 35.533v-2.887h-3.763v-1.084h3.763v-2.237a.467.467 0 0 0-.467-.467h-3.3v-5.927a5.546 5.546 0 0 0
