<script>
  ...
  export let ariaLabel = "GraphConfidenceBands";
  let autoScale = 18;
  afterUpdate(() => {
...
<svg
  ...
  <path
    d="M15.9 20.984a1 1 0 0 0 .582-1.814l-1.627-1.162a1 1 0 1 0-1.155 1.629l1.622 1.163a1.009 1.009 0 0 0
    ...
    .487-.11z" />
  <path
    d="M35.976 0L24.355 4.357a.983.983 0 0 0-.355.229l-7.6 7.6-7.451-1.864a1.007 1.007 0 0 0-.949.264l-8 8v2.828L9.014
