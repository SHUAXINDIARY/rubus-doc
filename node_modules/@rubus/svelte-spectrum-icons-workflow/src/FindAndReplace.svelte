<script>
  ...
  export let ariaLabel = "FindAndReplace";
  let autoScale = 18;
  afterUpdate(() => {
...
<svg
  ...
  <path
    d="M35.63 32.628l-6.275-8.385a12.011 12.011 0 1 0-20.63-6.9A6.561 6.561 0 0 0 11 18.623a10.005 10.005 0 1 1 9.087
  ...
  <path
    d="M23.467 15.737a11.152 11.152 0 0 1-5.213 6.974c-5.068 2.8-11.526.878-14.8-4.259l2.415-1.336A8.337 8.337 0 0 0
