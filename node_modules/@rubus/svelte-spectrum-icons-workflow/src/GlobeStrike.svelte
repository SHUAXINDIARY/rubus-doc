<script>
  ...
  export let ariaLabel = "GlobeStrike";
  let autoScale = 18;
  afterUpdate(() => {
...
<svg
  ...
  <path
    d="M7.146 13.769a6.06 6.06 0 0 1-.21-1.883L4.509 9.458A16.017 16.017 0 0 0 2 18c0 9.112 7.943 14.542 13.554
  ...
  <rect height={42.243} rx={0.509} ry={0.509} transform="rotate(-45 18.065 18.065)" width={3} x={16.565} y={-3.056} />
</svg>
