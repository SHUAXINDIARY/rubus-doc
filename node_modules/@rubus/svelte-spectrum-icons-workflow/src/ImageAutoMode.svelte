<script>
  ...
  export let ariaLabel = "ImageAutoMode";
  let autoScale = 18;
  afterUpdate(() => {
...
<svg
  ...
  <path
    d="M20.865.409l.1 2.842a2.318 2.318 0 0 0 1.186 1.939l2.482 1.39-2.843.1a2.317 2.317 0 0 0-1.938 1.184l-1.39
  ...
  <path
    d="M26 22v6.463l-3.687-3.686a2 2 0 0 0-2.828 0l-3.071 3.071-7.556-7.556a2 2 0 0 0-2.829 0L2 24.321V14h21l-3-2H1a1 1
