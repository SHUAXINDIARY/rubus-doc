<script>
  ...
  export let ariaLabel = "DeselectCircular";
  let autoScale = 18;
  afterUpdate(() => {
...
<svg
  ...
  <rect height={43.854} rx={0.818} ry={0.818} transform="rotate(-45 18 18)" width={2.455} x={16.772} y={-3.927} />
  <path
    d="M31.569 21.45a13.9 13.9 0 0 1-1.661 3.895l1.448 1.448a15.884 15.884 0 0 0 2.152-4.852zM29.1
