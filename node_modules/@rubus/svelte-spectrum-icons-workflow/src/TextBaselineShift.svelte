<script>
  ...
  export let ariaLabel = "TextBaselineShift";
  let autoScale = 18;
  afterUpdate(() => {
...
<svg
  ...
  <path
    d="M21.3 23.776L13.061 3c-.037-.129-.071-.16-.212-.16H9.412a.16.16 0 0 0-.176.16 3.073 3.073 0 0 1-.246 1.312L1.345
  ...
  <rect height={2} rx={0.5} ry={0.5} width={21} x={1} y={26} />
  <rect height={2} rx={0.5} ry={0.5} width={12} x={23} y={16} />
  <path
    d="M33.537 11.728a9.194 9.194 0 0 0 .047 1.148c0 .048 0 .071-.047.1A9.872 9.872 0 0 1 29.065 14c-2.536
