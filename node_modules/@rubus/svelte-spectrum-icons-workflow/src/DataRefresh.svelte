<script>
  ...
  export let ariaLabel = "DataRefresh";
  let autoScale = 18;
  afterUpdate(() => {
...
<svg
  ...
  <path
    d="M14.8 30.2v-3.3a9.618 9.618 0 0 1 .116-1.1 13.076 13.076 0 0 1 .371-1.624C10.233 23.846 3.5 22.644 2 20.27V29c0
    ...
    33.435z" />
  <path
    d="M33.558 20.958A9.215 9.215 0 0 0 27 18a9.3 9.3 0 0 0-9 9h2.28A6.889 6.889 0 0 1 27 20.565a6.283 6.283 0 0 1 4.871
