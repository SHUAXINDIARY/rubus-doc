<script>
  ...
  export let ariaLabel = "ReportAdd";
  let autoScale = 18;
  afterUpdate(() => {
...
<svg
  ...
  <path
    d="M15.084 30H10.5a.5.5 0 0 1-.5-.5v-3a.5.5 0 0 1 .5-.5h4.25a12.252 12.252 0 0 1 .334-2H10.5a.5.5 0 0
  ...
  <path
    d="M27.1 18.2a8.9 8.9 0 1 0 8.9 8.9 8.9 8.9 0 0 0-8.9-8.9zm5 9.4a.5.5 0 0 1-.5.5h-3.5v3.5a.5.5 0 0 1-.5.5h-1a.5.5 0
