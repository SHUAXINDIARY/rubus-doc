<script>
  ...
  export let ariaLabel = "DocumentRefresh";
  let autoScale = 18;
  afterUpdate(() => {
...
<svg
  ...
  <path
    d="M14 27a13 13 0 0 1 13-13c.338 0 .669.025 1 .05V10h-9a1 1 0 0 1-1-1V0H5a1 1 0 0 0-1 1v30a1 1 0 0 0 1 1h10a12.956
  ...
  <path
    d="M18.395 24.526a8.883 8.883 0 0 1 15.501-3.091l1.25-1.25a.489.489 0 0 1 .35-.148.5.5 0 0 1 .504.5v5a.5.5 0 0
