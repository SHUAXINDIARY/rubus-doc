<script>
  ...
  export let ariaLabel = "EmailNotification";
  let autoScale = 18;
  afterUpdate(() => {
...
<svg
  ...
  <path
    d="M20.576 28.545c.375-.381 1.254-1.27 1.254-5.854a4.825 4.825 0 0 1 2.47-4.215L22.866 17.4l-3.576 2.694a2.171 2.171
    ...
    8.422z" />
  <path
    d="M36 4.665v-1.5A1.147 1.147 0 0 0 34.875 2H1.125A1.147 1.147 0 0 0 0 3.167v1.468l18 13.553zM0
