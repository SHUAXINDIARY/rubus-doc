<script>
  ...
  export let ariaLabel = "LinkGlobe";
  let autoScale = 18;
  afterUpdate(() => {
...
<svg
  ...
  <path
    d="M14.748 28.057a8.007 8.007 0 0 1-.822-.232c-.52.52-1.5 1.547-1.713 1.762a4.1 4.1 0 1 1-5.8-5.8L13.6 16.6a4.585
  ...
  <path
    d="M16.926 20.056a3.579 3.579 0 0 1-.594-.478 4.159 4.159 0 0 1-1.241-1.625 2.041 2.041 0 0 0-.428.318l-1.636
  ...
  <path
    d="M35.24 27.573c-.9-.341-1.664.821-1.732-2.316a3.206 3.206 0 0 1 .927-2.225 1.718 1.718 0 0 1 .405-.194 9.09 9.09 0
