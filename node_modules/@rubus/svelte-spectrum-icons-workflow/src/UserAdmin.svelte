<script>
  ...
  export let ariaLabel = "UserAdmin";
  let autoScale = 18;
  afterUpdate(() => {
...
<svg
  ...
  <path
    d="M13.62 25.92a12.287 12.287 0 0 1 5.427-10.2 1.48 1.48 0 0 1 .331-.753 10.775 10.775 0 0 0 1.962-3.679 9.906 9.906
  ...
  <path
    d="M35.23 24.541h-2.415a6.98 6.98 0 0 0-1.02-2.476l1.72-1.72a.69.69 0 0 0 0-.975l-1.045-1.045a.69.69 0 0 0-.975
