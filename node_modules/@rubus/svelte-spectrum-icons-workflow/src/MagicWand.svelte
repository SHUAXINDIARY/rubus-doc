<script>
  ...
  export let ariaLabel = "MagicWand";
  let autoScale = 18;
  afterUpdate(() => {
...
<svg
  ...
  <rect height={4} rx={1} ry={1} transform="rotate(-45 12.249 21.751)" width={30.118} x={-2.811} y={19.752} />
  <path
    d="M31.506 13.559l.078 2.156a1.756 1.756 0 0 0 .9 1.47l1.882 1.054-2.156.078a1.756 1.756 0 0 0-1.47.9L29.684
