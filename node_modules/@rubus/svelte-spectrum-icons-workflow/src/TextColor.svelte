<script>
  ...
  export let ariaLabel = "TextColor";
  let autoScale = 18;
  afterUpdate(() => {
...
<svg
  ...
  <path
    d="M14.059 27.869A6.854 6.854 0 0 1 16 24.548V8h8v3a1 1 0 0 0 1 1h2a1 1 0 0 0 1-1V5a1 1 0 0 0-1-1H1a1 1 0 0 0-1
    1v6a1 1 0 0 0 1 1h2a1 1 0 0 0 1-1V8h8v20H9a1 1 0 0 0-1 1v2a1 1 0 0 0 1 1h5.162a6.948 6.948 0 0 1-.103-4.131z" />
  <path
    d="M35.8 24.128c-1.156-4.61-5.8-6.14-8.685-5.777-2.516.316-4.366 1.172-4.4 2.557-.019.772.411 1.1 1.159
