<script>
  ...
  export let ariaLabel = "FeedManagement";
  let autoScale = 18;
  afterUpdate(() => {
...
<svg
  ...
  <path
    d="M14.74 28H6v-6h9.76a12.256 12.256 0 0 1 1.126-2H6v-6h24v1.069a12.216 12.216 0 0 1 2 .69V5a1 1 0 0 0-1-1H5a1 1 0 0
    0-1 1v24a1 1 0 0 0 1 1h10.069a12.246 12.246 0 0 1-.329-2zM6 6h24v6H6z" />
  <path
    d="M35.193 25.786h-2.125a6.142 6.142 0 0 0-.9-2.179l1.513-1.513a.607.607 0 0 0 0-.858l-.92-.92a.607.607 0 0 0-.858
