<script>
  ...
  export let ariaLabel = "AssetsLinkedPublished";
  let autoScale = 18;
  afterUpdate(() => {
...
<svg
  ...
  <path
    d="M20.689 28.358l7.745 4.317a.7.7 0 0 0 .938-.312L34.9 18.6zM18 29.182v6.34a.426.426 0 0 0
    .7.325l4.535-3.857zM7.662 24H4V4h28v10.506l2-.611V3a1 1 0 0 0-1-1H3a1 1 0 0 0-1 1v22a1 1 0 0 0 1 1h7.737z" />
  <path
    d="M33.949 17.052l-21.921 6.742a.349.349 0 0 0-.056.647l6.064 2.966zM14.474 8.015h-.725a6.758 6.758 0 0
  ...
  <path
    d="M21.567 18.011h.725a6.758 6.758 0 0 0 3.367-.97 5.311 5.311 0 0 0 2.149-2.511 4.227 4.227 0 0 0 .156-2.4 5.187
