<script>
  ...
  export let ariaLabel = "IdentityService";
  let autoScale = 18;
  afterUpdate(() => {
...
<svg
  ...
  <path
    d="M8.607 31.849a1 1 0 0 1-.546-1.838c7.322-4.776 9.058-13.395 9.076-13.482a1 1 0 0 1 1.963.379c-.075.387-1.921
    9.544-9.948 14.779a1 1 0 0 1-.545.162z" />
  <path
    d="M12.638 34.637a1 1 0 0 1-.628-1.779A27.887 27.887 0 0 0 21.5 17.5a4.008 4.008 0 0 0-.51-2.876 3.386 3.386 0 0
  ...
  <path
    d="M25.937 32.588a1 1 0 0 1-.835-1.549c4.357-6.632 4.862-11.355 4.881-11.554a17.247 17.247 0 0 0-.385-6.169 1 1 0 0
