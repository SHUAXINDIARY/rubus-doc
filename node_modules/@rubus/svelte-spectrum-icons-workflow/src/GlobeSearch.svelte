<script>
  ...
  export let ariaLabel = "GlobeSearch";
  let autoScale = 18;
  afterUpdate(() => {
...
<svg
  ...
  <path
    d="M7.146 13.769C6.1 9.982 8.8 8.352 8.534 5.116A16.073 16.073 0 0 0 2 18c0 9.112 7.943 14.542 13.554 15.732a6.9 6.9
  ...
  <path
    d="M32.063 10.518c-.192-.349-.4-.684-.62-1.018-.037.019-.07.044-.109.062-1.25.583-1.423.755-2 0a1.576 1.576 0 0 1
