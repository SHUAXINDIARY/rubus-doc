<script>
  ...
  export let ariaLabel = "FolderUser";
  let autoScale = 18;
  afterUpdate(() => {
...
<svg
  ...
  <path
    d="M16 6H2V3.5A1.5 1.5 0 0 1 3.5 2h7.672a2 2 0 0 1 1.414.586zM28.677 28.542v-1.4a.966.966 0 0 1 .246-.623 7.366
  ...
  <path
    d="M19.689 26.959a10.321 10.321 0 0 1-1.41-5.031c0-4.959 3.16-8.424 7.686-8.424 4.564 0 7.633 3.385 7.633
