<script>
  ...
  export let ariaLabel = "UserDeveloper";
  let autoScale = 18;
  afterUpdate(() => {
...
<svg
  ...
  <path
    d="M12.518 29.409a2 2 0 0 1 0-2.828l6.1-6.1a2.606 2.606 0 0 1 1.525-.706 14.84 14.84 0 0 0 3.343-8.731C23.488 5.617
  ...
  <path
    d="M21.748 32.288L17.458 28l4.286-4.286a.432.432 0 0 0 0-.608l-.729-.728a.429.429 0 0 0-.607 0l-4.915 4.912a1 1 0 0
