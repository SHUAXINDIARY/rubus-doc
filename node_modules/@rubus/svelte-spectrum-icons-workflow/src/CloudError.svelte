<script>
  ...
  export let ariaLabel = "CloudError";
  let autoScale = 18;
  afterUpdate(() => {
...
<svg
  ...
  <path
    d="M27.688 14.026Q27.348 14 27 14a9.001 9.001 0 0 0-7.484 14H3.718A3.92 3.92 0 0 1 0 23.854c0-1.73 1.792-4.261
  ...
  <path
    d="M26.969 15.813a7.25 7.25 0 1 0 7.25 7.25 7.255 7.255 0 0 0-7.25-7.25zm-1.076 2.462c0-.053.15-.137.26-.178a2.27
