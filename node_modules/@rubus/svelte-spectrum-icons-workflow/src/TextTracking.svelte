<script>
  ...
  export let ariaLabel = "TextTracking";
  let autoScale = 18;
  afterUpdate(() => {
...
<svg
  ...
  <path
    d="M35.5 2H.5a.5.5 0 0 0-.5.5v21a.5.5 0 0 0 .5.5h35a.5.5 0 0 0 .5-.5v-21a.5.5 0 0 0-.5-.5zM12.073 21.555a.235.235 0
  ...
  <path
    d="M32.834 30.128l-4-4A.49.49 0 0 0 28.5 26a.5.5 0 0 0-.5.5V29H8v-2.5a.5.5 0 0 0-.5-.5.49.49 0 0 0-.331.129l-4
