<script>
  ...
  export let ariaLabel = "GlobeCheck";
  let autoScale = 18;
  afterUpdate(() => {
...
<svg
  ...
  <path
    d="M14.7 27a12.316 12.316 0 0 1 .408-3.1 50.148 50.148 0 0 0-2.772-4.5c-2.073-3.086-3.958-1.178-5.19-5.636C6.1 9.982
  ...
  <path
    d="M16.027 4.654a3.705 3.705 0 0 0-1.1-.452c-1.818-.211.88 4.777.777 4.114.5-2.292 3.612-3.176 4.565-.147a3.742
