<script>
  ...
  export let ariaLabel = "PersonalizationField";
  let autoScale = 18;
  afterUpdate(() => {
...
<svg
  ...
  <path
    d="M31 2H5a1 1 0 0 0-1 1v30a1 1 0 0 0 1 1h26a1 1 0 0 0 1-1V3a1 1 0 0 0-1-1zM12 29.5a.5.5 0 0 1-.5.5h-5a.5.5 0 0
