<script>
  ...
  export let ariaLabel = "GlobeStrikeClock";
  let autoScale = 18;
  afterUpdate(() => {
...
<svg
  ...
  <path d="M27 18.084a8.9 8.9 0 1 0 8.9 8.9 8.9 8.9 0 0 0-8.9-8.9zm0 15.9a7 7 0 1 1 7-7 7 7 0 0 1-7 7z" />
  <path
    d="M27.905 26.517v-4.128a.5.5 0 0 0-.5-.5h-1a.5.5 0 0 0-.5.5v5.229l3.275 2.072a.5.5 0 0 0 .69-.155l.535-.845a.5.5 0
