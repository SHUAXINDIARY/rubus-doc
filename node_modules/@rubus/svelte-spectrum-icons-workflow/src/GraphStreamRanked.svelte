<script>
  ...
  export let ariaLabel = "GraphStreamRanked";
  let autoScale = 18;
  afterUpdate(() => {
...
<svg
  ...
  <path
    d="M22.42 27.532C16.185 27.783 14.172 29.5 10 29.5c-3.929 0-6.961-2-8-2V34h32v-4.5c-7.555 0-9.58-1.7-11.58-1.968zM10
  ...
  <path
    d="M24.281 12.676C23.916 17.014 23.537 21.5 20 21.5a9.885 9.885 0 0 1-5.715-2.223C12.877 18.324 11.662 17.5 10
