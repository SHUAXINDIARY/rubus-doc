<script>
  ...
  export let ariaLabel = "Back30Seconds";
  let autoScale = 18;
  afterUpdate(() => {
...
<svg
  ...
  <path
    d="M24.031 2.675L25.853.854A.49.49 0 0 0 26 .5a.5.5 0 0 0-.5-.5h-5.053A.5.5 0 0 0 20 .447V5.5a.5.5 0 0 0
  ...
  <path
    d="M27.773 17.968c0-3.259-.986-6.968-4.931-6.968-3.216 0-4.995 2.98-4.995 6.968 0 3.923 1.479 7.032 5.016 7.032
  ...
  <path
    d="M14.052 17.475a3.114 3.114 0 0 0 1.761-2.852c0-2.165-1.529-3.623-4.025-3.623a6.385 6.385 0 0
