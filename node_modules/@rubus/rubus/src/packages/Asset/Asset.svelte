...
<div class="spectrum-Asset" bind:this={asset}>
  {#if variants == 'image'}
    <img
  ...
  {:else if variants == 'file'}
    <svg viewBox="0 0 128 128" class="spectrum-Asset-file">
      ...
      <path
        ...
        d="M113.1,23.3L92.6,2.9C90.7,1,88.2,0,85.5,0H24c-6.6,0-12,5.4-12,12v104c0,6.6,5.4,12,12,12h80c6.6,0,12-5.4,12-12V30.4C116,27.8,114.9,25.2,113.1,23.3z
  ...
  {:else if variants == 'folder'}
    <svg viewBox="0 0 32 32" class="spectrum-Asset-folder">
      ...
      <path
        ...
        d="M29,6H18.3c-0.1,0-0.2,0-0.4-0.2l-3.1-3.1C14.4,2.3,13.8,2,13.1,2H3C1.3,2,0,3.3,0,5v22c0,1.6,1.3,3,3,3h26c1.7,0,3-1.4,3-3V9C32,7.3,30.7,6,29,6z
        M31,27c0,1.1-0.9,2-2,2H3c-1.1,0-2-0.9-2-2V7h28c1.1,0,2,0.9,2,2V27z" />
    </svg>
  {:else if variants == 'customize'}
    <slot />
  {/if}
</div>
