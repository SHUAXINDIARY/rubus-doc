...
</style></head><body><article class="spectrum-CSSComponent"><header class="spectrum-CSSComponent-heading"><h1 class="spectrum-CSSComponent-title spectrum-Heading spectrum-Heading--sizeXXXL spectrum-Heading--serif"><a class="spectrum-BigSubtleLink" href="#undefined">Color Wheel</a></h1><p class="spectrum-CSSComponent-version spectrum-Body spectrum-Body--sizeS">Version 1.0.0-beta.3</p></header><section class="spectrum-CSSComponent-description spectrum-Body spectrum-Body--sizeL"><ul>
<li>For a given rotation on the wheel, <code class="spectrum-Code spectrum-Code--sizeS">X</code>, the <code class="spectrum-Code spectrum-Code--sizeS">.spectrum-ColorHandle</code> should be moved by applying the style property <code class="spectrum-Code spectrum-Code--sizeS">transform: translate(${67.5 * Math.cos(X)}px, ${67.5 * Math.sin(X)}px)</code></li>
<li>Set the value of the ColorHandle component to the selected color</li>
<li>Set the <code class="spectrum-Code spectrum-Code--sizeS">value</code> attribute of <code class="spectrum-Code spectrum-Code--sizeS">.spectrum-ColorWheel-value</code> to the currently selected color (i.e. <code class="spectrum-Code spectrum-Code--sizeS">hsl(326, 100%, 50%)</code>)</li>
<li>Add <code class="spectrum-Code spectrum-Code--sizeS">.is-dragged</code> when the handle is being dragged</li>
</ul>
</section><article class="spectrum-CSSExample"><header><h3 class="spectrum-CSSExample-heading spectrum-Heading spectrum-Heading--sizeS">Standard</h3></header><section class="spectrum-CSSExample-container"><div class="spectrum-CSSExample-example"><div class="spectrum-ColorWheel">
...
</div></section></article><article class="spectrum-CSSExample"><header><h3 class="spectrum-CSSExample-heading spectrum-Heading spectrum-Heading--sizeS">Disabled</h3></header><section class="spectrum-CSSExample-container"><div class="spectrum-CSSExample-example"><div class="spectrum-ColorWheel is-disabled">
  <svg class="spectrum-ColorWheel-wheel" viewBox="0 0 160 160" aria-hidden="true">
    <defs>
      <mask id="mask">
        <circle cx="80" cy="80" r="80" fill="white" />
...
</div></section></article><article class="spectrum-CSSExample"><header><h3 class="spectrum-CSSExample-heading spectrum-Heading spectrum-Heading--sizeS">Standard (with canvas)</h3></header><section class="spectrum-CSSExample-container"><div class="spectrum-CSSExample-example"><div class="spectrum-ColorWheel">
