...
function create_fragment$7(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(span0, file$7, 220, 2, 14635);
			attr_dev(span1, "class", "spectrum-Tooltip-tip");
			add_location(span1, file$7, 221, 2, 14702);
			...
			add_location(span2, file$7, 202, 0, 13850);
		},
		m: function mount(target, anchor) {
...
function create_each_block_1(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(div0, file$a, 229, 10, 9523);
			attr_dev(div1, "class", "color-item-code svelte-rdoezz");
			add_location(div1, file$a, 230, 10, 9585);
			...
			add_location(div2, file$a, 223, 8, 9178);
		},
		m: function mount(target, anchor) {
		...
		p: function update(new_ctx, dirty) {
			...
			if (dirty & /*colorModel, $rubusDocConfig, colorDisplay*/ 13) tooltip_changes.label = /*colorModel*/ ctx[0] == "hex"
			? /*colorItem*/ ctx[14].code.toUpperCase()
			: hexToRGB(/*colorItem*/ ctx[14].code).toUpperCase();
...
function create_each_block(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(div, file$a, 221, 4, 9111);
		},
		m: function mount(target, anchor) {
			insert_dev(target, div, anchor);
